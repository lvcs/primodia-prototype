...
// Planet Tiles (Points)
export const MAX_NUMBER_OF_PLANET_TILES = 128000;
export const DEFAULT_NUMBER_OF_PLANET_TILES = 1280;
export const MIN_NUMBER_OF_PLANET_TILES = 50; // From UI slider min
export const STEP_NUMBER_OF_PLANET_TILES = 50; // From UI slider step

// Tectonic Plates
export const MIN_TECHTONIC_PLATES = 4;    // From UI slider min
export const MAX_TECHTONIC_PLATES = 128;    // From UI slider max
export const DEFAULT_TECHTONIC_PLATES = 16; // From planetSettings default
...
// Planet Rotation Damping and Inertia
...
export const planetViewOptions = [
...
// Trees Configuration
export const TREES_DENSITY_PER_UNIT_AREA = 0.0003; // Trees per square unit (increased for denser forests)
export const TREES_BASE_HEIGHT = 60.0; // Increased for better visibility
export const TREES_BASE_RADIUS = 18.0; // Increased for better proportions
export const TREES_SIZE_VARIATION = 0.3; // ±30% variation for more variety
export const TREES_TRUNK_COLOR = 0x8B4513; // Saddle brown
export const TREES_CANOPY_COLOR = 0x228B22; // Forest green 